...
/** Badge palette — Figma 1094:847 (forms list) */
export const statusBadge = {
  "قيد التنفيذ": { bg: "rgba(245,158,11,0.1)", fg: "#F59E0B" },
  "بانتظار المراجعة": { bg: "rgba(245,158,11,0.1)", fg: "#F59E0B" },
  "مطلوب تعديل": { bg: "rgba(220,38,38,0.1)", fg: "#DC2626" },
  "قيد المراجعة": { bg: "rgba(234,88,12,0.1)", fg: "#EA580C" },
  "بانتظار الاعتماد": { bg: "rgba(234,88,12,0.1)", fg: "#EA580C" },
  معتمد: { bg: "rgba(22,163,74,0.1)", fg: "#16A34A" },
  معتمدة: { bg: "rgba(22,163,74,0.1)", fg: "#16A34A" },
  "إرسال للجهة": { bg: "rgba(5,44,101,0.1)", fg: "#052C65" },
  "تم الإرسال": { bg: "rgba(5,44,101,0.1)", fg: "#052C65" },
  "تم إرساله للجهة": { bg: "rgba(5,44,101,0.1)", fg: "#052C65" },
  "قيد الاعتماد": { bg: "rgba(234,88,12,0.1)", fg: "#EA580C" },
};
