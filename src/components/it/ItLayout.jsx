...
import {
  LayoutDashboard, Building2, Building, ScrollText, Users, Clock,
  NotepadText, Settings, LogOut, Bell,
} from "lucide-react";
import { user } from "../../data/mockIt";
import { useAuth } from "../../context/AuthContext";
import { APP_NAME } from "../../constants/branding";

/** Order matches the sidebar in Figma node 895:2509 */
const NAV = [
          ...
          <div className="h-[74px] bg-white flex items-center justify-between px-4 sm:px-7 shrink-0 sticky top-0 z-10">
            <div className="text-right min-w-0">
              {breadcrumb ? (
                ...
                <h1 className="text-[22px] sm:text-[26px] font-bold text-[#052c65] truncate">{title}</h1>
              )}
            </div>
            <div className="flex items-center gap-4 sm:gap-6 shrink-0">
              ...
              <div className="flex items-center gap-3">
                <div className="text-right leading-tight hidden sm:block">
                  ...
                  <div className="text-[13px] text-[#0986ed]">{role || user.role}</div>
                </div>
                <img
                  src="https://api.dicebear.com/7.x/initials/svg?seed=MS&backgroundColor=e5e7eb"
